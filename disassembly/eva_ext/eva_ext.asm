...
;* This Version uses 32kBit of                      *
;* TextRAM (A12 must be tied low).                  *
;* Changes are:                                     *
;* .) Startup screen,                               *
;* .) extended Test Picture,                        *
;* .) ROM Start @ $F000,                            *
;* .) initialisation of the HD6845,                 *
;* .) Handling the Overflow of the TextRAM,         *
;* .) Functions to move the 6845 Window up and down *
;*    (MovWind_Up, MovWind_Dwn and PutWdwBack)      *
;* .) Possibility to Jump into Monitor              *
;****************************************************
;
...
MC6845_7280Z   FCB     $62             ; Set Register 0 (H Total) - 98
               ...
               FCB     $52             ; Set Register 8 (Interlace Md. and Skew) - 162
...
MC6845_3240Z   FCB     $30             ; Set Register 0 (H Total) - 48
               ...
               FCB     $19             ; Set Register 6 (V Displayed) - 25
               FCB     $1B             ; Set Register 7 (V Sync. Pos.) - 27
               FCB     $50             ; Set Register 8 (Interlace Md. and Skew) - 160
               FCB     $09             ; Set Register 9 (Max. Scanline Address)
               FCB     $00             ; Set Register 10 (Crsr Start)
               FCB     $10             ; Set Register 11 (Crsr End) - 16
               FCB     $00             ; Set Register 12 (Start Address H)
...
GREETING       FCC     '             EVA-1 Reproduction.        '
               FCC     '                OFFNER 2025             '
               FCC     '                    v1.1                '
               FCC     '  Verbinden mit HX-20 ueber gekreuztes  '
               FCC     '    Kabel und "SCREEN 1,0 eingeben.     '
               FCC     '  CTRL+1: Text On/Off                   '
               FCC     '  CTRL+2: Invert                        '
               FCC     '  CTRL+3: 32 Columns                    '
               FCC     '  CTRL+4: 40 Columns                    '
               FCC     '  CTRL+5: Cursor Blink                  '
               FCC     '  CTRL+6: Clear Graphics Screen         '
               FCC     '  CTRL+7: 72 Columns                    '
